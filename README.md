...
Test assignment. Build a performance-focused data grid from scratch using React.

**Challenge:** Implement virtualized rendering, sorting, filtering, inline editing — all in under 1 hour using AI-assisted development (Claude).
